/* @license C3.js v0.7.20 | (c) C3 Team and other contributors | http://c3js.org/ */ ! function (t, e) {
    ...
    function n(t) {
        this.internal = new l(this), this.internal.loadConfig(t), this.internal.beforeInit(t), this.internal.init(), this.internal.afterInit(t),
            function e(i, n, r) {
    ...
    function c(t) {
        var e = function (t) {
            ...
            return 0 < e ? parseInt(t.substring(e + 5, t.indexOf(".", e)), 10) : 0 < (e = t.indexOf("Trident/")) && (e = t.indexOf("rv:"), parseInt(t.substring(e + 3, t.indexOf(".", e)), 10))
        }();
    ...
    e.prototype.axisX = function (t, e, i) {
        ...
        function T(t, m) {
            ...
            return t.each(function () {
                ...
                g.exit().remove();
                var f, _, x = n.selectAll(".domain").data([0]),
                ...
                a.rangeBand ? (_ = (f = a).rangeBand() / 2, r = a = function (t) {
                    return f(t) + _
                }) : r.rangeBand ? r = a : d.call(t, a, w.tickOffset), c.call(t, r, w.tickOffset), S = (m ? l.transition(m) : l).style("opacity", 1).call(t, a, w.tickOffset)
            }), S
        }
        return T.scale = function (t) {
            ...
            return arguments.length ? (w.tickArguments = arguments, T) : w.tickArguments
    ...
    var Y = {
        ...
        p = function (t) {
            this.owner = t, this.d3 = t.d3, this.internal = e
        },
        t = p;
    t.prototype.init = function () {
        ...
        return d && l.tickFormat(d), s.isTimeSeriesY() ? l.ticks(c.axis_y_tick_time_type, c.axis_y_tick_time_interval) : l.tickValues(n), l
        ...
        var i, n, r, a, o = this.owner,
            s = 0;
        return e && o.currentMaxTickWidths[t] || (o.svg && (i = o.filterTargetsToShow(o.data.targets), "y" === t ? (n = o.y.copy().domain(o.getYDomain(i, "y")), r = this.getYAxis(t, n, o.yOrient, o.yAxisTickValues, !1, !0, !0)) : "y2" === t ? (n = o.y2.copy().domain(o.getYDomain(i, "y2")), r = this.getYAxis(t, n, o.y2Orient, o.y2AxisTickValues, !1, !0, !0)) : (n = o.x.copy().domain(o.getXDomain(i)), r = this.getXAxis(n, o.xOrient, o.xAxisTickFormat, o.xAxisTickValues, !1, !0, !0), this.updateXAxisTickValues(i, r)), (a = o.d3.select("body").append("div").classed("c3", !0)).append("svg").style("visibility", "hidden").style("position", "fixed").style("top", 0).style("left", 0).append("g").call(r).each(function () {
        ...
        if (e)
            ...
            for (o = n - 2, r = t[0], s = ((a = t[t.length - 1]) - r) / (1 + o), l = [r], c = 0; c < o; c++) d = +r + s * (c + 1), l.push(i ? new Date(d) : d);
            l.push(a)
        }
    ...
    function f(t, e, i) {
        ...
        return e || (e = t.scaleLinear()).range(n), i || ((i = t.scaleLog()).domain(n), i.nice()), r.domain = function (t) {
            ...
            return function (t, e, i) {
                ...
                o = (e - t) / (r = i - 1), a = t, (n = new Array(i))[0] = Math.pow(10, a);
    ...
    l.prototype.beforeInit = function () {}, l.prototype.afterInit = function () {}, l.prototype.init = function () {
        var t = this,
            e = t.config;
        ...
        var e = this,
            i = e.config;
        e.updateTargetsForText(t), e.updateTargetsForBar(t), e.updateTargetsForLine(t), e.hasArcType() && e.updateTargetsForArc && e.updateTargetsForArc(t), i.subchart_show && e.updateTargetsForSubchart && e.updateTargetsForSubchart(t), e.showTargets()
        ...
        var i, n, r, a, o, s, c, d, l, u, h, g, p, f, _, x = this,
            y = x.main,
            m = x.d3,
            S = x.config,
            ...
            H = X ? z : 0,
            N = M ? z : 0;
        if (e = e || x.axis.generateTransitions(N), k && S.legend_show ? x.updateLegend(x.mapToIds(x.data.targets), t, e) : D && x.updateDimension(!0), x.isCategorized() && 0 === A.length && x.x.domain([0, x.axes.x.selectAll(".tick").size()]), A.length ? (x.updateXDomain(A, E, O, I), S.axis_x_tick_values || (u = x.axis.updateXAxisTickValues(A))) : (x.xAxis.tickValues([]), x.subXAxis.tickValues([])), S.zoom_rescale && !t.flow && (p = x.x.orgDomain()), x.y.domain(x.getYDomain(A, "y", p)), x.y2.domain(x.getYDomain(A, "y2", p)), !S.axis_y_tick_values && S.axis_y_tick_count && x.yAxis.tickValues(x.axis.generateTickValues(x.y.domain(), S.axis_y_tick_count)), !S.axis_y2_tick_values && S.axis_y2_tick_count && x.y2Axis.tickValues(x.axis.generateTickValues(x.y2.domain(), S.axis_y2_tick_count)), x.axis.redraw(N, T), x.axis.updateLabels(V), (E || R) && A.length)
        ...
        i = x.generateDrawArea ? x.generateDrawArea(w, !1) : void 0, n = x.generateDrawBar ? x.generateDrawBar(v) : void 0, r = x.generateDrawLine ? x.generateDrawLine(b, !1) : void 0, a = x.generateXYForText(w, v, b, !0), o = x.generateXYForText(w, v, b, !1), x.updateCircleY(), f = (x.config.axis_rotated ? x.circleY : x.circleX).bind(x), _ = (x.config.axis_rotated ? x.circleX : x.circleY).bind(x), C && (x.subY.domain(x.getYDomain(A, "y")), x.subY2.domain(x.getYDomain(A, "y2"))), x.updateXgridFocus(), y.select("text." + Y.text + "." + Y.empty).attr("x", x.width / 2).attr("y", x.height / 2).text(S.data_empty_label_text).transition().style("opacity", A.length ? 0 : 1), F && x.redrawEventRect(), x.updateGrid(z), x.updateStanfordElements(z), x.updateRegion(z), x.updateBar(H), x.updateLine(H), x.updateArea(H), x.updateCircle(f, _), x.hasDataLabel() && x.updateText(a, o, H), x.redrawTitle && x.redrawTitle(), x.redrawArc && x.redrawArc(z, H, G), S.subchart_show && x.redrawSubchart && x.redrawSubchart(L, e, z, H, w, v, b), x.isStanfordGraphType() && x.drawColorScale(), y.selectAll("." + Y.selectedCircles).filter(x.isBarType.bind(x)).selectAll("circle").remove(), t.flow && (d = x.generateFlow({
            ...
            xForText: a,
            yForText: o
        })), z && x.isTabVisible() ? (l = m.transition().duration(z), s = [], [x.redrawBar(n, !0, l), x.redrawLine(r, !0, l), x.redrawArea(i, !0, l), x.redrawCircle(f, _, !0, l), x.redrawText(a, o, t.flow, !0, l), x.redrawRegion(!0, l), x.redrawGrid(!0, l)].forEach(function (t) {
            t.forEach(function (t) {
                s.push(t)
            })
        }), c = x.generateWait(), s.forEach(function (t) {
            c.add(t)
        }), c(function () {
            d && d(), S.onrendered && S.onrendered.call(x)
        })) : (x.redrawBar(n), x.redrawLine(r), x.redrawArea(i), x.redrawCircle(f, _), x.redrawText(a, o, t.flow), x.redrawRegion(), x.redrawGrid(), d && d(), S.onrendered && S.onrendered.call(x)), x.mapToIds(x.data.targets).forEach(function (t) {
            x.withoutFadeIn[t] = !0
        })
    }, l.prototype.updateAndRedraw = function (t) {
        var e, i = this,
            n = i.config;
        (t = t || {}).withTransition = B(t, "withTransition", !0), t.withTransform = B(t, "withTransform", !1), t.withLegend = B(t, "withLegend", !1), t.withUpdateXDomain = B(t, "withUpdateXDomain", !0), t.withUpdateOrgXDomain = B(t, "withUpdateOrgXDomain", !0), t.withTransitionForExit = !1, t.withTransitionForTransform = B(t, "withTransitionForTransform", t.withTransition), i.updateSizes(), t.withLegend && n.legend_show || (e = i.axis.generateTransitions(t.withTransitionForAxis ? n.transition_duration : 0), i.updateScales(), i.updateSvgSize(), i.transformAll(t.withTransitionForTransform, e)), i.redraw(t, e)
        ...
        var i = this,
            n = e ? t[e] : t.value;
        return i.isTimeSeries() ? n = i.parseDate(t.value) : i.isCategorized() && "string" == typeof t.value && (n = i.config.axis_x_categories.indexOf(t.value)), Math.ceil(i.x(n))
        ...
        function t(t) {
            var i = setInterval(function () {
                var e;
                n.isTabVisible() && (e = 0, r.forEach(function (t) {
                    if (t.empty()) e += 1;
                    else try {
                        t.transition()
                    } catch (t) {
        ...
        var e;
        return t instanceof Date ? e = t : "string" == typeof t ? e = this.dataTimeParse(t) : "object" != typeof t && ("number" != typeof t || isNaN(t)) || (e = new Date(+t)), e && !isNaN(+e) || window.console.error("Failed to parse x '" + t + "' to Date object"), e
    }, l.prototype.isTabVisible = function () {
        return !document.hidden
    }, l.prototype.getPathBox = m, l.prototype.CLASS = Y, "SVGPathSeg" in window || (window.SVGPathSeg = function (t, e, i) {
        ...
        var e;
        this._pathElement && (e = !1, t.forEach(function (t) {
        ...
        "object" == typeof t ? (C(t.x) && (i.axis_x_max = t.x), C(t.y) && (i.axis_y_max = t.y), C(t.y2) && (i.axis_y2_max = t.y2)) : i.axis_y_max = i.axis_y2_max = t, e.redraw({
            withUpdateOrgXDomain: !0,
            withUpdateXDomain: !0
        })
        ...
        "object" == typeof t ? (C(t.x) && (i.axis_x_min = t.x), C(t.y) && (i.axis_y_min = t.y), C(t.y2) && (i.axis_y2_min = t.y2)) : i.axis_y_min = i.axis_y2_min = t, e.redraw({
            withUpdateOrgXDomain: !0,
            withUpdateXDomain: !0
        })
        ...
        k(t.y) && (e.config.axis_y_type = t.y), k(t.y2) && (e.config.axis_y2_type = t.y2), e.updateScales(), e.redraw()
        ...
        var e = this.internal;
        return window.clearInterval(e.intervalForObserveInserted), void 0 !== e.resizeTimeout && window.clearTimeout(e.resizeTimeout), window.removeEventListener("resize", e.resizeIfElementDisplayed), e.resizeFunction.remove(), e.unbindWindowFocus(), e.selectChart.classed("c3", !1).html(""), Object.keys(e).forEach(function (t) {
            e[t] = null
        }), null
        ...
        r = c.convertDataToTargets(e, !0), c.data.targets.forEach(function (t) {
            for (var e, i = !1, n = 0; n < r.length; n++)
                if (t.id === r[n].id) {
                    for (i = !0, t.values[t.values.length - 1] && (h = t.values[t.values.length - 1].index + 1), u = r[n].values.length, e = 0; e < u; e++) r[n].values[e].index = h + e, c.isTimeSeries() || (r[n].values[e].x = h + e);
            ...
            for (var e, i = 0; i < d.length; i++)
                if (t.id === d[i])
                    for (h = t.values[t.values.length - 1].index + 1, e = 0; e < u; e++) t.values.push({
                        id: t.id,
                        index: h + e,
            ...
            for (var e = [], i = c.data.targets[0].values[0].index; i < h; i++) e.push({
                id: t.id,
                index: i,
        ...
        return function () {
            ...
            E.flowing = !0, E.data.targets.forEach(function (t) {
                t.values.splice(0, v)
            }), e = E.updateXDomain(i, !0, !0), E.updateXGrid && E.updateXGrid(!0), n = E.xgrid || I.selectAll([]), r = E.xgridLines || I.selectAll([]), a = E.mainRegion || I.selectAll([]), o = E.mainText || I.selectAll([]), s = E.mainBar || I.selectAll([]), c = E.mainLine || I.selectAll([]), d = E.mainArea || I.selectAll([]), l = E.mainCircle || I.selectAll([]), t = "translate(" + (u.orgDataCount ? 1 === u.orgDataCount || (b && b.x) === (T && T.x) || E.isTimeSeries() ? E.x(A[0]) - E.x(e[0]) : E.x(b.x) - E.x(T.x) : 1 !== E.data.targets[0].values.length ? E.x(A[0]) - E.x(e[0]) : E.isTimeSeries() ? (b = E.getValueOnIndex(E.data.targets[0].values, 0), T = E.getValueOnIndex(E.data.targets[0].values, E.data.targets[0].values.length - 1), E.x(b.x) - E.x(T.x)) : R(e) / 2) + ",0) scale(" + R(A) / R(e) + ",1)", E.hideXGridFocus();
            var V = I.transition().ease(I.easeLinear).duration(P);
            L.add(E.xAxis(E.axes.x, V)), L.add(s.transition(V).attr("transform", t)), L.add(c.transition(V).attr("transform", t)), L.add(d.transition(V).attr("transform", t)), L.add(l.transition(V).attr("transform", t)), L.add(o.transition(V).attr("transform", t)), L.add(a.filter(E.isRegionOnX).transition(V).attr("transform", t)), L.add(n.transition(V).attr("transform", t)), L.add(r.transition(V).attr("transform", t)), L(function () {
                var t, e = [],
                    i = [];
                if (v) {
        ...
        return (n ? a.transition().duration(n) : a).style("opacity", 0).remove(), i.regions = i.regions.filter(function (t) {
            var e = !1;
        ...
        t = n.mapToTargetIds(t), e = e || {}, n.removeHiddenTargetIds(t), (i = n.svg.selectAll(n.selectorTargets(t))).transition().style("display", c() ? "block" : "initial", "important").style("opacity", 1, "important").call(n.endall, function () {
        ...
        var e = this.internal;
        e.config.subchart_show || (e.config.subchart_show = !0, e.initSubchart(), e.updateDimension(), e.initSubchartBrush(), e.updateTargetsForSubchart(e.getTargets()), e.mapToIds(e.data.targets).forEach(function (t) {
            e.withoutFadeIn[t] = !1
        }), e.updateAndRedraw(), e.showTargets())
        ...
        var t, i, n = this.internal,
            ...
            r = e.mouse ? e.mouse : (e.data ? i = e.data : void 0 !== e.x && (t = e.id ? n.data.targets.filter(function (t) {
                return t.id === e.id
            }) : n.data.targets, i = n.filterByX(t, e.x).slice(0, 1)[0]), i ? n.getMousePosition(i) : null);
        ...
        n && (t.isOrderAsc() || t.isOrderDesc()) && (i = n, n = function (t, e) {
            return -1 * i(t, e)
        }), t.pie.sort(n || null)
        ...
        return o.shouldShowArcLabel() ? (i = (e = o.updateAngle(t)) ? e.value : null, n = o.getRatio("arc", e), r = t.data.id, o.hasType("gauge") || o.meetsArcLabelThreshold(n) ? (a = o.getArcLabelFormat()) ? a(i, n, r) : o.defaultArcValueFormat(i, n) : "") : ""
        ...
        o.append("g").attr("class", r), o.append("text").attr("dy", e.hasType("gauge") ? "-.1em" : ".35em").style("opacity", 0).style("text-anchor", "middle").style("pointer-events", "none")
        ...
        var n, r, a, o, l = this,
            ...
            c = l.main,
            d = l.hasType("gauge"),
            h = c.selectAll("." + Y.arcs).selectAll("." + Y.arc).data(l.arcData.bind(l)),
            g = h.enter().append("path").attr("class", l.classArc.bind(l)).style("fill", function (t) {
        ...
        d && (r = (n = c.selectAll("." + Y.arcs).selectAll("." + Y.arcLabelLine).data(l.arcData.bind(l))).enter().append("rect").attr("class", function (t) {
        ...
        }).merge(n), 1 === l.filterTargetsToShow(l.data.targets).length ? r.style("display", "none") : r.style("fill", function (t) {
            ...
            l.transiting = !1
        }), h.exit().transition().duration(e).style("opacity", 0).remove(), c.selectAll("." + Y.chartArc).select("text").style("opacity", 0).attr("class", function (t) {
        ...
        }), c.select("." + Y.chartArcsTitle).style("opacity", l.hasType("donut") || d ? 1 : 0), d && (a = 0, (o = l.arcs.select("g." + Y.chartArcsBackground).selectAll("path." + Y.chartArcsBackground).data(l.data.targets)).enter().append("path").attr("class", function (t, e) {
        ...
        for (var e = [], i = 0; i < t.length; i++) t[i] in this.cache && e.push(this.cloneTarget(this.cache[t[i]]));
        return e
        ...
        Object.keys(a).forEach(function (t) {
            i = e, n = t.split("_"), r = function t() {
                var e = n.shift();
                return e && i && "object" == typeof i && e in i ? (i = i[e], t()) : e ? void 0 : i
            }(), k(r) && (a[t] = r)
        })
    }, l.prototype.convertUrlToData = function (t, e, i, n, r) {
        var a, o = this,
            s = e || "csv",
            c = "json" === s ? (a = o.d3.json, o.convertJsonToData) : (a = "tsv" === s ? o.d3.tsv : o.d3.csv, o.convertXsvToData);
        ...
        return 0 === t.length ? {
            ...
            rows: [e.reduce(function (t, e) {
                var i;
                return Object.assign(t, ((i = {})[e] = null, i))
            }, {})]
        } : {
            keys: e,
            rows: [].concat(t)
        ...
        var r, a = this,
            o = [],
            i = t ? (t.x ? (r = t.value.concat(t.x), a.config.data_x = t.x) : r = t.value, o.push(r), e.forEach(function (i) {
                var n = [];
        ...
        for (var e = [], i = t[0], n = 1; n < t.length; n++) {
            for (var r = {}, a = 0; a < t[n].length; a++) {
                if (w(t[n][a])) throw new Error("Source data is missing a component at (" + n + "," + a + ")!");
                r[i[a]] = t[n][a]
            }
            e.push(r)
        }
        ...
        for (var e = [], i = [], n = 0; n < t.length; n++) {
            for (var r = t[n][0], a = 1; a < t[n].length; a++) {
                if (w(e[a - 1]) && (e[a - 1] = {}), w(t[n][a])) throw new Error("Source data is missing a component at (" + n + "," + a + ")!");
                e[a - 1][r] = t[n][a]
            }
            i.push(r)
        }
        ...
        var e, i, r, a, d, l = this,
            u = l.config;
        if (o(t) ? a = Object.keys(t[0]) : (a = t.keys, t = t.rows), r = a.filter(l.isX, l), l.isStanfordGraphType()) {
            if (d = a.filter(l.isEpochs, l), i = a.filter(l.isNotXAndNotEpochs, l), 1 !== r.length || 1 !== d.length || 1 !== i.length) throw new Error("You must define the 'x' key name and the 'epochs' for Stanford Diagrams")
        ...
        return i.forEach(function (i) {
            ...
            if (!l.data.xs[t]) throw new Error('x is not defined for id = "' + t + '".')
            ...
            return {
                ...
                values: t.map(function (t, e) {
                    var i, n, r = t[l.getXKey(o)],
                        a = null === t[o] || isNaN(t[o]) ? null : +t[o];
                    return l.isCustomX() && l.isCategorized() && !w(r) ? (0 === s && 0 === e && (u.axis_x_categories = []), -1 === (i = u.axis_x_categories.indexOf(r)) && (i = u.axis_x_categories.length, u.axis_x_categories.push(r))) : i = l.generateTargetX(r, o, e), (w(t[o]) || l.data.xs[o].length <= e) && (i = void 0), n = {
                        x: i,
                        value: a,
                        id: c
                    }, l.isStanfordGraphType() && (n.epochs = t[d]), n
                }).filter(function (t) {
                    return k(t.x)
                })
            }
        ...
        }), l.hasNegativeValue = l.hasNegativeValueInTargets(e), l.hasPositiveValue = l.hasPositiveValueInTargets(e), u.data_type && l.setTargetType(l.mapToIds(e).filter(function (t) {
            return !(t in u.data_types)
        }), u.data_type), e.forEach(function (t) {
        ...
        return e.data.targets.filter(function (t) {
            ...
            t.values.forEach(function (t, e) {
                i[e] || (i[e] = 0), i[e] += s(t.value) ? t.value : 0
            })
        }), e.addToCache("getTotalPerIndex", n), n[t]
        ...
        return e.addToCache("getTotalDataSum", n), n
        ...
        return t.filter(function (t) {
            ...
            var e;
            a || (e = o.main.select("." + Y.bars + o.getTargetSelectorSuffix(t.id) + " ." + Y.bar + "-" + t.index).node(), o.isWithinBar(i, e) && (a = t))
        }), t.filter(function (t) {
            return t && !o.isBarType(t.id)
        }).forEach(function (t) {
            var e = n(t, i);
        ...
        var n, r = this,
            a = r.api,
            o = 0;
        return e && a.data.shown.call(a).length && (o = e.ratio || e.value, "arc" === t ? o = r.hasType("gauge") ? (e.endAngle - e.startAngle) / (Math.PI * (r.config.gauge_fullCircle ? 2 : 1)) : (n = r.getTotalDataSum(), e.value / n) : "index" === t && (n = r.getTotalPerIndex(r.axis.getId(e.id)), e.ratio = s(e.value) && n && 0 < n[e.index] ? e.value / n[e.index] : 0, o = e.ratio)), i && o ? 100 * o : o
        ...
        var i = this;
        i.resetCache(), e.data ? i.load(i.convertDataToTargets(e.data), e) : e.url ? i.convertUrlToData(e.url, e.mimeType, e.headers, e.keys, function (t) {
        ...
        var i = this;
        i.resetCache(), e = e || function () {}, (t = t.filter(function (t) {
        ...
        var a, o, s, c, d, l, u, h, g, p, f, _ = t.filter(function (t) {
            ...
            b = n.hasType("bar", x) && r.bar_zerobased || n.hasType("area", x) && r.area_zerobased,
        ...
        var e, i, n, r = this.config,
            a = t[1] - t[0],
            o = this.isCategorized() ? 0 : this.hasType("bar") ? 1 < (e = this.getMaxDataCount()) ? a / (e - 1) / 2 : .5 : .01 * a;
        return "object" == typeof r.axis_x_padding && L(r.axis_x_padding) ? (i = C(r.axis_x_padding.left) ? r.axis_x_padding.left : o, n = C(r.axis_x_padding.right) ? r.axis_x_padding.right : o) : i = n = "number" == typeof r.axis_x_padding ? r.axis_x_padding : o, {
            left: i,
            right: n
        }
        ...
        var e, i, n, r, h, g, p, f, _ = this,
            ...
            a = _.main,
            y = _.d3;
        _.hasArcType() || x.data_selection_enabled && x.data_selection_multiple && (e = _.dragStart[0], i = _.dragStart[1], n = t[0], r = t[1], h = Math.min(e, n), g = Math.max(e, n), p = x.data_selection_grouped ? _.margin.top : Math.min(i, r), f = x.data_selection_grouped ? _.height : Math.max(i, r), a.select("." + Y.dragarea).attr("x", h).attr("y", p).attr("width", g - h).attr("height", f - p), a.selectAll("." + Y.shapes).selectAll("." + Y.shape).each(function (t, e) {
            if (x.data_selection_isselectable(t)) {
                var i, n, r, a, o, s, c = y.select(this),
                    d = c.classed(Y.SELECTED),
                    l = c.classed(Y.INCLUDED),
                    u = !1;
                if (c.classed(Y.circle)) i = +c.attr("cx"), n = +c.attr("cy"), o = _.togglePoint, u = h < i && i < g && p < n && n < f;
                else {
                    if (!c.classed(Y.bar)) return;
                    i = (s = m(this)).x, n = s.y, r = s.width, a = s.height, o = _.togglePath, u = !(g < i || i + r < h || f < n || n + a < p)
                }
        ...
        var e = this,
            ...
            a = e.xx.bind(e);
        i.tooltip_show && (e.hasType("stanford") || e.hasArcType() || (r.style("visibility", "visible").data([n[0]]).attr(i.axis_rotated ? "y1" : "x1", a).attr(i.axis_rotated ? "y2" : "x2", a), e.smoothLines(r, "grid")))
        ...
        function l() {
            s.svg.select("." + Y.eventRect).style("cursor", null), s.hideXGridFocus(), s.hideTooltip(), s.unexpandCircles(), s.unexpandBars()
        }
        ...
        s.main.select("." + Y.eventRects).style("cursor", d.zoom_enabled ? d.axis_rotated ? "ns-resize" : "ew-resize" : null), s.eventRect.attr("x", 0).attr("y", 0).attr("width", s.width).attr("height", s.height).on("mouseout", d.interaction_enabled ? function () {
            d && (s.hasArcType() || (s.mouseover && (d.data_onmouseout.call(s.api, s.mouseover), s.mouseover = void 0), l()))
        } : null).on("mousemove", d.interaction_enabled ? function () {
            if (!s.dragging) {
                var t = s.getTargetsToShow();
                if (!s.hasArcType(t)) {
                    var e, i, n, r = c.mouse(this),
                        a = h(s.findClosestFromTargets(t, r)),
                        o = u(r, a);
                    if (!s.mouseover || a && a.id === s.mouseover.id && a.index === s.mouseover.index || (d.data_onmouseout.call(s.api, s.mouseover), s.mouseover = void 0), a && !s.mouseover && (d.data_onmouseover.call(s.api, a), s.mouseover = a), s.svg.select("." + Y.eventRect).style("cursor", o ? "pointer" : null), !d.tooltip_grouped || s.hasType("stanford", t) ? a && (e = [a]) : (n = void 0, (n = a || (i = d.axis_rotated ? r[1] : r[0], s.findClosestFromTargetsByX(t, s.x.invert(i)))) && (e = s.filterByX(t, n.x))), !e || 0 === e.length) return l();
                    e = e.map(h), s.showTooltip(e, this), d.point_focus_expand_enabled && (s.unexpandCircles(), e.forEach(function (t) {
                        s.expandCircles(t.index, t.id, !1)
                    })), s.unexpandBars(), e.forEach(function (t) {
            ...
            s.hasArcType(n) || (t = c.mouse(this), e = h(s.findClosestFromTargets(n, t)), u(t, e) && ((!d.data_selection_grouped || s.isStanfordType(e) ? [e] : s.filterByX(n, e.x)).forEach(function (t) {
            ...
            }), e && (i = s.main.selectAll("." + Y.shapes + s.getTargetSelectorSuffix(e.id)).select("." + Y.shape + "-" + e.index), d.data_onclick.call(s.api, e, i.node()))))
        ...
        function R(t, e, i) {
            ...
            function p(t, e) {
                e || (n = (g - C - h) / 2) < A && (n = (g - h) / 2, C = 0, I++), O[t] = I, E[I] = m.isLegendInset ? 10 : n, L[t] = C, C += h
            }
            s && (T = b = I = C = 0), !S.legend_show || m.isLegendToShow(e) ? (V[e] = l, G[e] = u, (!b || b <= l) && (b = l), (!T || T <= u) && (T = u), r = m.isLegendRight || m.isLegendInset ? T : b, S.legend_equally ? (Object.keys(V).forEach(function (t) {
                V[t] = b
            }), Object.keys(G).forEach(function (t) {
                G[t] = T
            }), (n = (g - r * f.length) / 2) < A ? (I = C = 0, f.forEach(function (t) {
                p(t)
            })) : p(e, !0)) : p(e)) : V[e] = G[e] = O[e] = L[e] = 0
        }
        f = f.filter(function (t) {
            return !k(S.data_names[t]) || null !== S.data_names[t]
        }), h = B(t = t || {}, "withTransition", !0), g = B(t, "withTransitionForTransform", !0), m.isLegendInset && (I = S.legend_inset_step ? S.legend_inset_step : f.length, m.updateLegendStep(I)), a = m.isLegendRight ? (i = function (t) {
            return b * O[t]
        }, function (t) {
            return E[O[t]] + L[t]
        ...
        } : m.color).attr("x1", c).attr("y1", l).attr("x2", d).attr("y2", l), y && (h ? y.transition() : y).attr("height", m.getLegendHeight() - 12).attr("width", b * (I + 1) + 10), m.legend.selectAll("." + Y.legendItem).classed(Y.legendItemHidden, function (t) {
            return !m.isTargetToShow(t)
        }), m.updateLegendItemWidth(b), m.updateLegendItemHeight(T), m.updateLegendStep(I), m.updateSizes(), m.updateScales(), m.updateSvgSize(), m.transformAll(g, e), m.legendHasRendered = !0
        ...
        }), r.append("text").text(e.labelRegion.bind(e)), e.mainRegion = r.merge(n).attr("class", e.classRegion.bind(e)), n.exit().transition().duration(t).style("opacity", 0).remove()
        ...
        var r, a = this.getScale(t, e, this.isTimeSeries()),
            o = i ? a.domain(i) : a,
            a = this.isCategorized() ? (n = n || function () {
                return 0
            }, function (t, e) {
                var i = o(t) + n(t);
        ...
        else if ("log" === t) n = f(this.d3);
        else {
            if ("linear" !== t && void 0 !== t) throw new Error('Invalid Y axis type: "' + t + '"');
        ...
        i.mainBar = s.merge(o).style("opacity", a), o.exit().transition().duration(t).style("opacity", 0)
        ...
        return function (r, a) {
            ...
            return i.forEach(function (t) {
                ...
                t.id !== r.id && d[t.id] === d[r.id] && u.indexOf(t.id) < u.indexOf(r.id) && (!w(e[a]) && +e[a].x == +r.x || (a = -1, e.forEach(function (t, e) {
        ...
        c.append("g").attr("class", r), c.append("g").attr("class", a), c.append("g").attr("class", function (t) {
        ...
        return d.line_connectNull || (l = l.defined(function (t) {
            ...
            function (t) {
                var e = d.line_connectNull ? c.filterRemoveNull(t.values) : t.values,
                    ...
                    r = 0,
                    a = 0,
                    o = c.isLineType(t) ? d.data_regions[t.id] ? c.lineWithRegions(e, i, n, d.data_regions[t.id]) : (c.isStepType(t) && (e = c.convertValuesToStep(e)), l.curve(c.getInterpolate(t))(e)) : (e[0] && (r = i(e[0].x), a = n(e[0].value)), d.axis_rotated ? "M " + a + " " + r : "M " + r + " " + a);
                return o || "M 0 0"
            }
        ...
        var i, n, r, a, u, o, s, c, h, g, p, f = this,
            _ = f.config,
            x = "M",
            y = f.isCategorized() ? .5 : 0,
            m = [];
        if (k(e))
            for (i = 0; i < e.length; i++) m[i] = {}, w(e[i].start) ? m[i].start = t[0].x : m[i].start = f.isTimeSeries() ? f.parseDate(e[i].start) : e[i].start, w(e[i].end) ? m[i].end = t[t.length - 1].x : m[i].end = f.isTimeSeries() ? f.parseDate(e[i].end) : e[i].end;
        ...
        for (g = _.axis_rotated ? function (t) {
            ...
            if (w(m) || ! function (t, e) {
                ...
                }(t[i].x, m)) x += " " + g(t[i]) + " " + p(t[i]);
            else
                for (a = f.getScale(t[i - 1].x + y, t[i].x + y, f.isTimeSeries()), u = f.getScale(t[i - 1].value, t[i].value), o = d(t[i].x) - d(t[i - 1].x), s = l(t[i].value) - l(t[i - 1].value), h = 2 * (c = 2 / Math.sqrt(Math.pow(o, 2) + Math.pow(s, 2))), n = c; n <= 1; n += h) x += r(t[i - 1], t[i], n, c);
            t[i].x
        }
        return x
        ...
        return o.line_connectNull || (s = s.defined(function (t) {
            ...
            function (t) {
                var e = o.line_connectNull ? a.filterRemoveNull(t.values) : t.values,
                    i = 0,
                    n = 0,
                    r = a.isAreaType(t) ? (a.isStepType(t) && (e = a.convertValuesToStep(e)), s.curve(a.getInterpolate(t))(e)) : (e[0] && (i = a.x(e[0].x), n = a.getYScale(t.id)(e[0].value)), o.axis_rotated ? "M " + n + " " + i : "M " + i + " " + n);
                return r || "M 0 0"
            }
        ...
        i.mainCircle = r.merge(n).style("opacity", i.isStanfordGraphType() ? 1 : i.initialOpacityForCircle.bind(i)), n.exit().style("opacity", 0)
        ...
        return t.colorScale && t.colorScale.node() && (i += t.getColorScalePadding()), i
        ...
        i.style("visibility", "visible"), i.append("g").attr("clip-path", t.clipPathForSubchart).attr("class", Y.chart), i.select("." + Y.chart).append("g").attr("class", Y.chartBars), i.select("." + Y.chart).append("g").attr("class", Y.chartLines), i.append("g").attr("clip-path", t.clipPath).attr("class", Y.brush), t.axes.subx = i.append("g").attr("class", Y.axisX).attr("transform", t.getTranslate("subx")).attr("clip-path", e.axis_rotated ? "" : t.clipPathForXAxis).style("visibility", e.subchart_axis_x_show ? "visible" : "hidden")
        ...
        var e, i, n = this,
            ...
            u = r.select("." + Y.chartBars).selectAll("." + Y.chartBar).data(t),
            h = u.enter().append("g").style("opacity", 0);
        h.merge(u).attr("class", o), h.append("g").attr("class", s), (e = (i = r.select("." + Y.chartLines).selectAll("." + Y.chartLine).data(t)).enter().append("g").style("opacity", 0)).merge(i).attr("class", c), e.append("g").attr("class", d), e.append("g").attr("class", l), r.selectAll("." + Y.brush + " rect").attr(a.axis_rotated ? "width" : "height", a.axis_rotated ? n.width2 : n.height2)
        ...
        var s, c, d, l = this,
            u = l.d3;
        u.event && "zoom" === u.event.type && l.brush.selectionAsValue(l.x.orgDomain()), t && (l.brush.empty() || l.brush.selectionAsValue(l.x.orgDomain()), s = l.generateDrawArea(r, !0), c = l.generateDrawBar(a, !0), d = l.generateDrawLine(o, !0), l.updateBarForSubchart(i), l.updateLineForSubchart(i), l.updateAreaForSubchart(i), l.redrawBarForSubchart(c, i, i), l.redrawLineForSubchart(d, i, i), l.redrawAreaForSubchart(s, i, i))
        ...
        var n, r = this,
            a = d(i),
            o = r.config.axis_rotated ? (n = r.isBarType(e) ? 4 : 6, t[2][1] + n * (e.value < 0 ? -1 : 1)) : r.hasType("bar") ? (t[2][0] + t[0][0]) / 2 : t[0][0];
        return null === e.value && (o > r.width ? o = r.width - a.width : o < 0 && (o = 4)), o
        ...
        if (l < 0) throw Error("Colorscale's barheight and barwidth must be greater than 0.");
        a = o.height - c.stanford_padding.bottom - c.stanford_padding.top, e = s.range(c.stanford_padding.bottom, a, 5), r = s.scaleSequential(d.colors).domain([e[e.length - 1], e[0]]), o.colorScale && o.colorScale.remove(), o.colorScale = o.svg.append("g").attr("width", 50).attr("height", a).attr("class", Y.colorScale), o.colorScale.append("g").attr("transform", "translate(0, " + c.stanford_padding.top + ")").selectAll("bars").data(e).enter().append("rect").attr("y", function (t, e) {
            return 5 * e
        }).attr("x", 0).attr("width", l).attr("height", 5).attr("fill", function (t) {
            return r(t)
        }), n = s.scaleLog().domain([d.minEpochs, d.maxEpochs]).range([e[0] + c.stanford_padding.top + e[e.length - 1] + 5 - 1, e[0] + c.stanford_padding.top]), i = s.axisRight(n), "pow10" === c.stanford_scaleFormat ? i.tickValues([1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7]) : h(c.stanford_scaleFormat) ? i.tickFormat(c.stanford_scaleFormat) : i.tickFormat(s.format("d")), h(c.stanford_scaleValues) && i.tickValues(c.stanford_scaleValues(d.minEpochs, d.maxEpochs)), t = o.colorScale.append("g").attr("class", "legend axis").attr("transform", "translate(" + l + ",0)").call(i), "pow10" === c.stanford_scaleFormat && t.selectAll(".tick text").text(null).filter(x).text(10).append("tspan").attr("dy", "-.7em").text(function (t) {
        ...
        if (a.values.sort(v), t = a.values.map(function (t) {
                return t.epochs
            }), i = isNaN(r.stanford_scaleMin) ? n.min(t) : r.stanford_scaleMin, (e = isNaN(r.stanford_scaleMax) ? n.max(t) : r.stanford_scaleMax) < i) throw Error("Number of minEpochs has to be smaller than maxEpochs");
        a.colors = h(r.stanford_colors) ? r.stanford_colors : n.interpolateHslLong(n.hsl(250, 1, .5), n.hsl(0, 1, .5)), a.colorscale = n.scaleSequentialLog(a.colors).domain([i, e]), a.minEpochs = i, a.maxEpochs = e
        ...
        for (var e, i, n, r = y(t), a = 0, o = 0, s = 0, c = t.length - 1; s < t.length; c = s, s += 1) i = t[s], n = t[c], e = i.x * n.y - n.x * i.y, a += (i.x + n.x) * e, o += (i.y + n.y) * e;
        return {
            x: a / (e = 6 * r),
            y: o / e
        }
    ...
    var y = function (t) {
            for (var e, i, n = 0, r = 0, a = t.length - 1; r < t.length; a = r, r += 1) e = t[r], i = t[a], n += e.x * i.y, n -= e.y * i.x;
            return n /= 2
        },
        S = function (t, e) {
            for (var i, n, r, a, o = t.x, s = t.value, c = !1, d = 0, l = e.length - 1; d < e.length; l = d++) i = e[d].x, n = e[d].y, a = e[l].x, s < n != s < (r = e[l].y) && o < (a - i) * (s - n) / (r - n) + i && (c = !c);
            return c
        },
        v = function (t, e) {
    ...
    return l.prototype.initStanfordElements = function () {
        var t = this;
        t.stanfordElements = t.main.select("." + Y.chart).append("g").attr("class", Y.stanfordElements), t.stanfordElements.append("g").attr("class", Y.stanfordLines), t.stanfordElements.append("g").attr("class", Y.stanfordTexts), t.stanfordElements.append("g").attr("class", Y.stanfordRegions)
        ...
        var e, i, n, r, a = this,
            ...
            u = o.select("." + Y.stanfordLines).style("shape-rendering", "geometricprecision").selectAll("." + Y.stanfordLine).data(s.stanford_lines),
            h = u.enter().append("g").attr("class", function (t) {
        ...
        h.append("line").attr("x1", function (t) {
        ...
        }).style("opacity", 0), a.stanfordLines = h.merge(u), a.stanfordLines.select("line").transition().duration(t).attr("x1", function (t) {
            return s.axis_rotated ? d(t, "value_y1") : c(t, "value_x1")
        }).attr("x2", function (t) {
            return s.axis_rotated ? d(t, "value_y2") : c(t, "value_x2")
        }).attr("y1", function (t) {
            ...
            return s.axis_rotated ? c(t, "value_x2") : d(t, "value_y2")
        }).style("opacity", 1), u.exit().transition().duration(t).style("opacity", 0).remove(), (r = (n = o.select("." + Y.stanfordTexts).selectAll("." + Y.stanfordText).data(s.stanford_texts)).enter().append("g").attr("class", function (t) {
        ...
        }).style("opacity", 0), a.stanfordTexts = r.merge(n), a.stanfordTexts.select("text").transition().duration(t).attr("x", function (t) {
            return s.axis_rotated ? d(t, "y") : c(t, "x")
        }).attr("y", function (t) {
            return s.axis_rotated ? c(t, "x") : d(t, "y")
        }).text(function (t) {
            return t.content
        }).style("opacity", 1), n.exit().transition().duration(t).style("opacity", 0).remove(), (i = (e = o.select("." + Y.stanfordRegions).selectAll("." + Y.stanfordRegion).data(s.stanford_regions)).enter().append("g").attr("class", function (t) {
        ...
        }).style("opacity", 0), a.stanfordRegions = i.merge(e), a.stanfordRegions.select("polygon").transition().duration(t).attr("points", function (t) {
            return t.points.map(function (t) {
                return [s.axis_rotated ? d(t, "y") : c(t, "x"), s.axis_rotated ? c(t, "x") : d(t, "y")].join(",")
            }).join(" ")
            ...
            var e, i, n;
            return t.text ? (a.isStanfordGraphType() && (e = (n = l(t.points)).value, i = n.percentage), t.text(e, i)) : ""
        }).attr("text-anchor", "middle").attr("dominant-baseline", "middle").style("opacity", 1), e.exit().transition().duration(t).style("opacity", 0).remove()
        ...
        for (f && t.sort(f), a = 0; a < t.length; a++)
            if (t[a] && (t[a].value || 0 === t[a].value)) {
                if (l.isStanfordGraphType()) r || (o = l.getStanfordTooltipTitle(t[a]), r = "<table class='" + l.CLASS.tooltip + "'>" + o), d = l.getStanfordPointColor(t[a]), c = _(u.data_epochs), s = t[a].epochs;
                else if (r || (o = _(h ? h(t[a].x, t[a].index) : t[a].x), r = "<table class='" + l.CLASS.tooltip + "'>" + (o || 0 === o ? "<tr><th colspan='2'>" + o + "</th></tr>" : "")), void 0 !== (s = _(p(t[a].value, t[a].ratio, t[a].id, t[a].index, t)))) {
                    if (null === t[a].name) continue;
                    c = _(g(t[a].name, t[a].ratio, t[a].id, t[a].index)), d = l.levelColor ? l.levelColor(t[a].value) : n(t[a].id)
                }
                void 0 !== s && (r += "<tr class='" + l.CLASS.tooltipName + "-" + l.getTargetSelectorSuffix(t[a].id) + "'>", r += "<td class='name'><span style='background-color:" + d + "'></span>" + c + "</td>", r += "<td class='value'>" + s + "</td>", r += "</tr>")
            } return r + "</table>"
        ...
        0 !== c.length && o.tooltip_show ? (a.tooltip.html(o.tooltip_contents.call(a, t, a.axis.getXAxisTickFormat(), a.getYFormat(s), a.color)).style("display", "block"), i = a.tooltip.property("offsetWidth"), n = a.tooltip.property("offsetHeight"), r = d.call(this, c, i, n, e), a.tooltip.style("top", r.top + "px").style("left", r.left + "px")) : a.hideTooltip()
        ...
        return i.zoom = n.zoom().on("start", function () {
            var t;
            "scroll" === r.zoom_type && ((t = n.event.sourceEvent) && "brush" === t.type || (e = t, r.zoom_onzoomstart.call(i.api, t)))
        }).on("zoom", function () {
            var t;
            "scroll" === r.zoom_type && ((t = n.event.sourceEvent) && "brush" === t.type || (i.redrawForZoom(), r.zoom_onzoom.call(i.api, i.x.orgDomain())))
        }).on("end", function () {
            var t;
            ...
            return n.event && n.event.transform && (r.axis_rotated && "scroll" === r.zoom_type && "mousemove" === n.event.sourceEvent.type ? i.x.domain(n.event.transform.rescaleY(i.subX).domain()) : i.x.domain(n.event.transform.rescaleX(i.subX).domain())), this
        ...
        "drag" === r.zoom_type && r.zoom_enabled && (e = function (t) {
            ...
            i.api.unzoom(), i.svg.select("." + Y.dragZoom).classed("disabled", !1), r.zoom_onzoomstart.call(i.api, n.event.sourceEvent)
        }).on("brush", function () {
            r.zoom_onzoom.call(i.api, e(n.event.selection))
        }).on("end", function () {
            var t;
            null != n.event.selection && (t = e(n.event.selection), r.zoom_disableDefaultBehavior || i.api.zoom(t), i.svg.select("." + Y.dragZoom).classed("disabled", !0), r.zoom_onzoomend.call(i.api, t))
